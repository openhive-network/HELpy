...
class BeekeeperCommon(PreconfiguredBaseModel):
    ...
    Timeout for unlocked wallet in seconds (default 900 (15 minutes)).Wallets will be automatically locked after
        specified number of seconds of inactivity.Activity is defined as any wallet command e.g. list-wallets.
    """
    ...
    webserver_unix_endpoint: P2PUrl | None = BeekeeperDefaults.DEFAULT_WEBSERVER_UNIX_ENDPOINT
    """
