...
class BeekeeperApi(AbstractSyncApi):
    endpoint = AbstractSyncApi.endpoint

    @endpoint
    def close(self, *, token: str, wallet_name: str) -> CloseResponse:
        """Closing implicitly locks the wallet"""

    @endpoint
    def close_session(self, *, token: str) -> CloseSessionResponse:
    ...
    @endpoint
    def get_info(self, *, token: str) -> GetInfoResponse:
    ...
    @endpoint
    def has_wallet(self, *, token: str, wallet_name: str) -> HasWalletResponse:
    ...
    @endpoint
    def list_wallets(self, *, token: str) -> list[ListWalletsResponseItem]:
        """List all opened wallets with information if given wallet is locked or not"""

    @endpoint
    def lock(self, *, token: str, wallet_name: str) -> LockResponse:
    ...
    @endpoint
    def lock_all(self, *, token: str) -> LockAllResponse:
        """All unlocked wallets are locked and implicitly closed"""

    @endpoint
    def open(self, *, token: str, wallet_name: str) -> OpenResponse:
    ...
    @endpoint
    def set_timeout(self, *, seconds: int, token: str) -> SetTimeoutResponse:
    ...
    @endpoint
    def unlock(self, *, password: str, token: str, wallet_name: str) -> UnlockResponse:
