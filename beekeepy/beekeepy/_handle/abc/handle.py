...
from beekeepy._handle.build_json_rpc_call import build_json_rpc_call
...
from beekeepy.exceptions.common import CommunicationError, RequestError
...
if TYPE_CHECKING:
    ...
    from beekeepy._handle.batch_handle import AsyncBatchHandle, SyncBatchHandle
    from beekeepy._interface.url import HttpUrl


class MissingResultError(BeekeepyError):
...
class AbstractHandle(UniqueSettingsHolder[Settings], ABC):
    ...
    def http_endpoint(self) -> HttpUrl:  # TODO: RESOLVE APPROPRIATE SETTING HANDLE
        ...
        return self.settings.http_endpoint  # type: ignore[return-value]
