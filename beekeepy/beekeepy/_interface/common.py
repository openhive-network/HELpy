    ...
    def check_wallet(
        ...
        if iscoroutinefunction(wrapped_function):
            ...
            async def async_impl(*args: P.args, **kwrags: P.kwargs) -> ResultT:
                this: WalletCommons[AsyncRemoteBeekeeper, AsyncWalletLocked, AsyncDelayGuard] = args[0]
        ...
        def sync_impl(*args: P.args, **kwrags: P.kwargs) -> ResultT:
            this: WalletCommons[SyncRemoteBeekeeper, SyncWalletLocked, SyncDelayGuard] = args[0]
