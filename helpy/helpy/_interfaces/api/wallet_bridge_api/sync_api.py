...
from helpy._interfaces.api.abc import AbstractSyncApi, ApiArgumentSerialization
from helpy._interfaces.api.wallet_bridge_api.common import WalletBridgeApiCommons
...
class WalletBridgeApi(AbstractSyncApi, WalletBridgeApiCommons):
    ...
    @api
    def get_witness(self) -> wallet_bridge_api.GetWitness:
        raise NotImplementedError
    ...
    @api
    def list_rc_direct_delegations(self, start: datetime, limit: int, /) -> wallet_bridge_api.ListRcDirectDelegations:
        raise NotImplementedError
