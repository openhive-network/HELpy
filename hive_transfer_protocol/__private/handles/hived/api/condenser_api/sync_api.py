...
class CondenserApi(AbstractSyncApi, CondenserApiCommons):
    ...
    @api
    def get_collateralized_conversion_requests(self, account: str) -> condenser_api.GetCollateralizedConversionRequests:
        raise NotImplementedError
    ...
    @api
    def list_rc_direct_delegations(self, start: tuple[str, str], limit: int) -> condenser_api.ListRcDirectDelegations:
        raise NotImplementedError
